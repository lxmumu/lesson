...
<!-- 点击博客日列表业务逻辑
当用户点击blog列表时，html请求服务器并传递单条blog id给服务器
服务器拿到id后根据id查询数据，并显示在网页 -->
                    <div class="frame">
                        <div class="title">博客列表</div>
                        <ul class="list">
                            <?php  foreach ($data as $value): ?>
<!-- 如何通过超链接的方式将数据id传送给服务器
get请求： 就是将数据追加到url中，传递给服务器
追加的方式：url?id=idvalue&id2=id2value;-->
<li>
     <a href="02blogindex.php?blogid=<?php echo $value['id']; ?>">
         <?php echo  $value['title']; ?>
<?php foreach ($category_num as $c): ?>
<?php
if ($value['id']==$c['category_id']):?>
<span> ( <?php echo $c['num']; ?>)</span>
<?php endif ?>
<?php endforeach ?>
<!-- 与上面等效 -->
<!-- <?php
...
<li>
    <a href=""> <?php echo $value['category']; ?>
    </a>
</li>
<?php  endforeach; ?>
                        </ul>
