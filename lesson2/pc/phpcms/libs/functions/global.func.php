...
//	查找 "plugin/" 在字符串中第一次出现的位置：
	if(strpos($module, 'plugin/')!== false) {
//		str_replace() 函数以''字符替换$module中的'plugin/'（区分大小写）。
...
//	strrchr查找字符在指定字符串中从左面开始的最后一次出现的位置，如果成功，返回该字符以及其后面的字符
//	substr(string,start,length)规定返回字符串，从何处开始，被返回字符串长度
