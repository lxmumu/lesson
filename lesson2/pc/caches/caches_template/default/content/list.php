        ...
        <div class="am-u-sm-12 am-u-md-9 am-u-lg-9">
            ...
            <div class="new-list">
                <ul>
                    ...
                    <li <?php if($catid==$r[catid]) { ?> class="on" <?php } ?>><?php echo date('Y-m-d H:i:s',$v[inputtime]);?><a href="<?php echo $v['url'];?>"  <?php echo title_style($v[style]);?>><span><?php echo $v['title'];?></span></a></li>
                    <?php $n++;}unset($n); ?>
                    <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
                </ul>
                <div class="page-list">
