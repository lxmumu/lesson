...
<div class="index-nav">
    <div class="cms-g">
        <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=dfa4b09d92e1696392533211d2b90aec&action=position&posid=19&num=4&order=id+DESC\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">修改</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'position')) {$data = $content_tag->position(array('posid'=>'19','order'=>'id DESC','limit'=>'4',));}?>
        ...
        <div class="am-u-sm-6 am-u-md-6 am-u-lg-3">
            <div class="index-nav-item">
                ...
                <div class="index-nav-info">
                    ...
                    <em class="font"><a href="<?php echo $v['url'];?>">详细介绍&#xe72f;</a></em>
                </div>
            </div>
        </div>
        <?php $n++;}unset($n); ?>
        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-4">
            <div class="index-content-left">
                ...
                <div class="am-slider am-slider-default" data-am-flexslider id="demo-slider-0">
                    ...
                    <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"get\" data=\"op=get&tag_md5=60ad4afdda555d7ce1da08ccb8cabed0&sql=SELECT+pictureurls+FROM+picture_data+WHERE+id%3D%24pic_id&cache=3600&return=data\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">修改</a>";}$tag_cache_name = md5(implode('&',array('sql'=>'SELECT pictureurls FROM picture_data WHERE id=$pic_id',)).'60ad4afdda555d7ce1da08ccb8cabed0');if(!$data = tpl_cache($tag_cache_name,3600)){pc_base::load_sys_class("get_model", "model", 0);$get_db = new get_model();$r = $get_db->sql_query("SELECT pictureurls FROM picture_data WHERE id=$pic_id LIMIT 20");while(($s = $get_db->fetch_next()) != false) {$a[] = $s;}$data = $a;unset($a);if(!empty($data)){setcache($tag_cache_name, $data, 'tpl_data');}}?>
