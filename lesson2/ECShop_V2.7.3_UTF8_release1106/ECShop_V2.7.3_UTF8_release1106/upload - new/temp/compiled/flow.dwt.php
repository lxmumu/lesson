...
?>
        ...
        <form id="formCart" name="formCart" method="post" action="flow.php">
            <div class="product well">
                    ...
                    <div class="col-md-9">
                       <h4> <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" class="f6"><?php echo $this->_var['goods']['goods_name']; ?></h4></a>
                        <?php endif; ?>
                         <hr/>
...
?>
            ...
            <?php endif; ?>
                    ...
                    <td align="right" bgcolor="#ffffff">
                        ...
                        <input type="text" name="goods_number[<?php echo $this->_var['goods']['rec_id']; ?>]" id="goods_number_<?php echo $this->_var['goods']['rec_id']; ?>" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="4" class="inputBg" style="text-align:center "  onblur="update_price(this)"/>
                        <input name="submit" type="submit" class="bnt_blue_1" value="Update"  style="background-color: pink"/>
                        <?php else: ?>
                        ...
                        <script>
                                ...
                                function update_callback(data) {
                                    ...
                                    <?php endif; ?>
                                    content =data.shopping_money;
                                    <?php if ($this->_var['show_marketprice']): ?>
                                    content =data.shopping_money+','+ data.market_price_desc;
                                    <?php endif; ?>
                                    alert(content);
                                    $('.total').html(content);
                    ...
                    <!--<td align="right" bgcolor="#ffffff"><?php echo $this->_var['goods']['subtotal']; ?></td>-->
                        ...
                        <a href="javascript:if (confirm('<?php echo $this->_var['lang']['drop_goods_confirm']; ?>')) location.href='flow.php?step=drop_goods&amp;id=<?php echo $this->_var['goods']['rec_id']; ?>'; " class="f6 btn btn-default pull-right" style="color: red">REMOVE</a>
           </td>
                </tr>
                    </div>
            ...
            <div class="col-md-4  col-md-offset-8">
                ...
                <hr/>
                <div>
                    <center><a href="flow.php?step=checkout"class="btn btn-1" alt="checkout">Checkout</a></center>
...
?>
    ...
    <form action="flow.php" method="post" name="theForm" id="theForm" onsubmit="return checkOrderForm(this)">
        ...
        <div class="flowBox">
            ...
            <table width="99%" height="200px"align="center" border="1" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                <tr>
...
?>
        ...
        <div class="flowBox">
            ...
            <table width="99%" height="200px" align="center" border="1" cellpadding="5" cellspacing="1" bgcolor="#dddddd" id="shippingTable">
                <tr>
...
?>
        ...
        <div class="flowBox">
            ...
            <table width="99%" height="200px" align="center" border="1" cellpadding="5" cellspacing="1" bgcolor="#dddddd" id="paymentTable">
                <tr>
...
?>
        ...
        <div class="flowBox">
            ...
            <table width="99%" height="200px" align="center" border="1" cellpadding="5" cellspacing="1" bgcolor="#dddddd" id="packTable">
                <tr>
...
?>
        ...
        <div class="flowBox">
            ...
            <table width="99%" height="200px" align="center" border="1" cellpadding="5" cellspacing="1" bgcolor="#dddddd" id="cardTable">
                <tr>
...
?>
        ...
        <div class="flowBox">
            <table width="99%"  height="300px"align="center" border="1" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                <tr>
