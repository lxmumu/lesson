...
?>
                    ...
                    <div class="col-md-6">
                            <div class="caption">
                                ...
                                <div class="price"><?php echo $this->_var['goods']['shop_price_formated']; ?><span><?php echo $this->_var['goods']['market_price']; ?></span></div>
...
?>
                                    ...
                                    <div class="well"><label><?php echo $this->_var['lang']['number']; ?>：</label> <input class="form-inline quantity" type="text" value="1" name="number" onblur="changePrice()"><a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" class="btn btn-2 ">ADD</a></div>

                                    <div class="well"><label><?php echo $this->_var['lang']['amount']; ?></label><font id="ECS_GOODS_AMOUNT" class="shop"></font>
                                    </div>
