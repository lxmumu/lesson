...
?>
          ...
          <tr>
              <td class="label"><label for="is_first"><input type="checkbox" id="is_first" name="is_first" value="1" <?php if ($this->_var['goods']['is_first']): ?>checked="checked"<?php endif; ?> /> 是否首发：</label></td>
              <td>
                  <input name="first_start_date" type="text" id="first_start_date" size="12" value='<?php echo $this->_var['goods']['first_start_date']; ?>' readonly="readonly" />
                  <input name="firstbtn1" type="button" id="firstbtn1" onclick="return showCalendar('first_start_date', '%Y-%m-%d', false, false, 'firstbtn1');" value="<?php echo $this->_var['lang']['btn_select']; ?>" class="button"/>
                  - <input name="first_end_date" type="text" id="first_end_date" size="12" value='<?php echo $this->_var['goods']['first_end_date']; ?>' readonly="readonly" />
                  <input name="firstbtn2" type="button" id="firstbtn2" onclick="return showCalendar('first_end_date', '%Y-%m-%d', false, false, 'firstbtn2');" value="<?php echo $this->_var['lang']['btn_select']; ?>" class="button"/>
              </td>
          </tr>
          <tr>
...
<!--            <td><input type="text" name="goods_number" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="20" <?php if ($this->_var['code'] != '' || $this->_var['goods']['_attribute'] != ''): ?>readonly="readonly"<?php endif; ?> /><br />-->
          ...
          <tr>
            ...
            <td>
              <input type="checkbox" name="is_best" value="1" <?php if ($this->_var['goods']['is_best']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_best']; ?>
              <input type="checkbox" name="is_new" value="1" <?php if ($this->_var['goods']['is_new']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_new']; ?>
              <input type="checkbox" name="is_hot" value="1" <?php if ($this->_var['goods']['is_hot']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_hot']; ?>
            </td>
          </tr>
          <tr id="alone_sale_1">
