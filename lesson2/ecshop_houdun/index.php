...
if ($act=='cat_pro') {
    ...
    $json = new JSON;
    $smarty->assign('goods',      get_category_recommend_goods(addslashes($_POST['type']), 0));    // 推荐商品
    $result['content'] = $smarty->fetch('library/recommend_goods.lbi');
...
if (!$smarty->is_cached('index.dwt', $cache_id))
{
    ...
    $smarty->assign('first_goods',     get_promote_goods('','first',2)); // 首发商品
